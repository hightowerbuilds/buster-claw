defmodule BusterClaw.Commands.Journal do
  @moduledoc "Journal commands (the Activity record). Delegated from `BusterClaw.Commands`."
  ...
  @doc """
  Read a day's Activity record. Defaults to today; a day with no document yet reads as
