defmodule BusterClawWeb do
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: BusterClawWeb.Gettext
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import BusterClawWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias BusterClawWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: BusterClawWeb.Endpoint,
        router: BusterClawWeb.Router,
        statics: BusterClawWeb.static_paths()
    end
  end
