defmodule BusterClawWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BusterClawWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BusterClawWeb.Gettext, "errors", msg, opts)
    end
  end
