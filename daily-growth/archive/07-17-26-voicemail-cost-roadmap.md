...
> **ARCHIVED 2026-07-18 — instrument built & verified 07-17.** The one open remainder, Phase 4 (the kill-transcription decision — transcription is $0.05 of each $0.0525 voicemail), moved to `../roadmaps/integrations/BUSTERPHONE_ROADMAP.md` (Cost section).
