...
├── integrations/ ··········· Part VI   CLINCH · BUSTERPHONE (+NUMBER_VENDING) · PHONE_INTAKE · SMS_DISCLOSURE (cancelled 08-18, archives at PHONE_INTAKE Phase 5) · PHONE_ACCESS · GOOGLE_VERIFICATION
...
| **The SMS consent story** | `Explained.Phone` | **CANCELLED 08-18 — archive unbuilt.** Its subject stops existing with outbound SMS. Its Part II line-by-line inventory of false claims survives as the map for `PHONE_INTAKE` Phase 4 | [`SMS_DISCLOSURE`](integrations/SMS_DISCLOSURE_ROADMAP.md) → superseded |
